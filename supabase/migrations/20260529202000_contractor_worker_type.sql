alter table public.profiles
  ...
  add column if not exists contractor_hst_applicable boolean not null default false;
...
drop function if exists public.admin_create_employee(text, text, text, text, numeric, boolean, integer, boolean);
