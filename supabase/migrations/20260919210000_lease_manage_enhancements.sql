...
-- Add INSERT paths for entities, buildings, and units in lease_save_record.
-- Portfolio-specific data changes are applied through the private import flow
-- and intentionally are not stored in this public repository.
