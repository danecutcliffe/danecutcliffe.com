...
Object.assign(values, {
  ...
  lessorLegalName: 'Example Holdings Inc.',
  lessorServiceStreet: '100 Example Street',
  ...
  premisesStreetAddress: '1-100 Example Street',
  ...
  rentDueDay: '1st',
  rentDuePeriod: 'Month',
  rentPaymentRecipientAndInstructions: 'Example Holdings Inc. - e-transfer',
  rentPaymentAddress: '100 Example Street, Charlottetown, PE',
  includedHeat: '     X',
  includedWater: '     X',
