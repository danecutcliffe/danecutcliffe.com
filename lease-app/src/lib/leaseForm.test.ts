...
const dataset: LeaseDataset = {
  ...
  buildings: [{ id:'building-a',entityId:'entity-a',displayName:'Building A',streetAddress:'1 Main',community:'Charlottetown',province:'PE',postalCode:'C1A 1A1' },{ id:'building-b',entityId:'entity-a',displayName:'Building B',streetAddress:'2 Main',community:'Charlottetown',province:'PE',postalCode:'C1A 1A2' }],
  units: [
