...
const dataset: LeaseDataset = {
  ...
  units: [
    { id:'unit-example-1',buildingId:'building-multi',entityId:'entity-example',displayName:'1-12 Example',unitNumber:'1',premisesStreetAddress:'1-12 Example Street',premisesCommunity:'Charlottetown',premisesPostalCode:'C1A 1A1',premisesType:'apartment',defaultRentalRate:1930,rentPeriod:'Month',rentDueDay:'1st',includedOptionIds:['option-included-heat','option-included-water','option-included-washer-dryer-no-charge'],tenantResponsibilityOptionIds:['option-waste'],inclusionConfigurationState:'known_populated',responsibilityConfigurationState:'known_populated' },
  ...
  standardOptions: [
    ...
    { id:'option-included-washer-dryer-no-charge',category:'included_standard',label:'Washer & Dryer (without charge)',pdfText:'Washer & Dryer (without charge)',active:true,systemKey:'washer_dryer_no_charge' },
    { id:'option-included-washer-dryer-coin',category:'included_standard',label:'Washer & Dryer (coin operated)',pdfText:'Washer & Dryer (coin operated)',active:true,systemKey:'washer_dryer_coin' },
